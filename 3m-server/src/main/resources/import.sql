...
insert into user_user (user_id, friends_id) values (2,1)
insert into user_user (user_id, friends_id) values (2,3)
insert into user_user (user_id, friends_id) values (1,2)
insert into user_user (user_id, friends_id) values (3,2)